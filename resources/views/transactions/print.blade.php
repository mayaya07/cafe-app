...
<body onload="window.print()">
    ...
    {{-- HITUNG ULANG TOTAL BIAR TRANSPARAN --}}
    @php
    ...
    <div class="no-print">
        <button onclick="window.print()" style="padding: 10px; background: #000; color: #fff; border: none; cursor: pointer;">
            CETAK SEMUA STRUK
        </button>
        <a href="{{ route('history') }}"
           style="display: inline-block; padding: 10px; background: #ccc; text-decoration: none; color: #000;">
            KEMBALI
        </a>
    </div>
    ...
    <div class="struk-pelanggan">
        ...
        <div class="flex">
            <span>Tipe: {{ $transaction->order_type }}</span>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            @foreach($transaction->details as $detail)
                <tr style="border-bottom: 1px solid #eee;">
                    <td style="font-size: 18px; font-weight: bold; padding: 5px 0;">
                        [ {{ $detail->quantity }} ]
                    </td>
